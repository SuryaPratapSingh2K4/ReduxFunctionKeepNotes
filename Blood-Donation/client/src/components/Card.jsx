...
function Card({ donation }) {
    ...
    return (
        <div className='bg-yellow-400 rounded-lg p-5 relative hover:shadow-xl w-full h-full max-h-[600px] cursor-pointer
        ' onClick={() => { setShowModal(true) }}>
            ...
            <div className='flex justify-center items-center gap-x-2'>
                <FaHospitalUser className='text-2xl text-customRed hover:text-white' />
                <h2>{donation.location}</h2>
            </div>

            <div className='flex justify-center items-center gap-x-2 mb-2 mt-8 py-5'>
